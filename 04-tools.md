...
| **π0 (Physical Intelligence)** | 开源VLA模型，由Physical Intelligence发布 | [GitHub](https://github.com/physical-intelligence/pi0) |
...
| **Robot Framework** | 通用自动化测试框架，强调自然语言，适用于机器人流程自动化 | [官网](https://robotframework.org) |
