...
| **课程名称** | 机构 | 简介 | 链接 |
| :-- | :-- | :-- | :-- |
| **示例课程** | 示例机构 | 一句话课程简介 | [课程链接](https://example.com) |
```
...
| **公司名称** | 一句话简介 | 技术方向 | 官网 |
| :-- | :-- | :-- | :-- |
| **示例公司** | 一句话简介 | `方向A` `方向B` | [官网](https://example.com) |
```
...
```md
<tr>
<td rowspan="2"><strong>示例公司</strong></td>
<td>机器人算法工程师</td>
<td>社招</td>
<td>上海</td>
<td><a href="https://example.com/jobs/123">投递</a></td>
</tr>
<tr>
<td>强化学习实习生</td>
<td>实习</td>
<td>北京</td>
<td><a href="https://example.com/jobs/456">投递</a></td>
</tr>
...
```md
- **[arXiv 2026年5月](https://arxiv.org/abs/2605.12345)** 示例论文标题. 一句话概括核心贡献。 [代码](https://github.com/example/repo)
```
...
| **工具名称** | 简介 | 链接 |
| :-- | :-- | :-- |
| **示例工具** | 一句话简介 | [Link](https://example.com) |
```
